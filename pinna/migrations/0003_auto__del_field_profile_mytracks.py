...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.mytracks'
        db.delete_column(u'pinna_profile', 'mytracks_id')


    def backwards(self, orm):
        # Adding field 'Profile.mytracks'
        db.add_column(u'pinna_profile', 'mytracks',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 10, 10, 0, 0), related_name='+', to=orm['pinna.Library']),
                      keep_default=False)
    ...
    models = {
        ...
        u'pinna.pinnasession': {
            ...
            'expired_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 11, 0, 0)'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'pinna.profile': {
            ...
            'mystations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'subscribers'", 'null': 'True', 'to': u"orm['pinna.Station']"}),
