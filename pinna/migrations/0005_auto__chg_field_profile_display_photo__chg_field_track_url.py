...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.display_photo'
        db.alter_column(u'pinna_profile', 'display_photo', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Track.url'
        db.alter_column(u'pinna_track', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'pinna.profile': {
            ...
            'display_photo': ('django.db.models.fields.TextField', [], {'null': 'True'}),
