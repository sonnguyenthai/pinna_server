...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'pinna_profile', 'display_photo', self.gf('django.db.models.fields.CharField')(max_length=2083, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.display_photo'
        db.alter_column(u'pinna_profile', 'display_photo', self.gf('django.db.models.fields.CharField')(max_length=65535, null=True))
