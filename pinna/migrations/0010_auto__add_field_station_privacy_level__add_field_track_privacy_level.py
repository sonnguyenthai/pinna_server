...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.privacy_level'
        db.add_column(u'pinna_station', 'privacy_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Track.privacy_level'
        db.add_column(u'pinna_track', 'privacy_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.privacy_level'
        db.delete_column(u'pinna_station', 'privacy_level')

        # Deleting field 'Track.privacy_level'
        db.delete_column(u'pinna_track', 'privacy_level')
