...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field hashtags on 'Station'
        m2m_table_name = db.shorten_name(u'pinna_station_hashtags')
        ...
        db.create_unique(m2m_table_name, ['station_id', 'hashtag_id'])


    def backwards(self, orm):
        # Removing M2M table for field hashtags on 'Station'
        db.delete_table(db.shorten_name(u'pinna_station_hashtags'))
