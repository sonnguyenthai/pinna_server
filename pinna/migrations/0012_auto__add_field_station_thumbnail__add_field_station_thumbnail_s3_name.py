...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.thumbnail'
        db.add_column(u'pinna_station', 'thumbnail',
                      self.gf('django.db.models.fields.CharField')(max_length=2083, null=True),
                      keep_default=False)

        # Adding field 'Station.thumbnail_s3_name'
        db.add_column(u'pinna_station', 'thumbnail_s3_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.thumbnail'
        db.delete_column(u'pinna_station', 'thumbnail')

        # Deleting field 'Station.thumbnail_s3_name'
        db.delete_column(u'pinna_station', 'thumbnail_s3_name')
    ...
    models = {
        ...
        u'pinna.pinnasession': {
            ...
            'expired_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 16, 0, 0)'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
