...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Track.like_count'
        db.delete_column(u'pinna_track', 'like_count')

        # Adding M2M table for field likes on 'Track'
        m2m_table_name = db.shorten_name(u'pinna_track_likes')
    ...
    def backwards(self, orm):
        # Adding field 'Track.like_count'
        db.add_column(u'pinna_track', 'like_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Removing M2M table for field likes on 'Track'
        db.delete_table(db.shorten_name(u'pinna_track_likes'))
    ...
    models = {
        ...
        u'pinna.pinnasession': {
            ...
            'expired_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 19, 0, 0)'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
