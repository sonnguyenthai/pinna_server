...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StationSubscriber', fields ['profile', 'station']
        db.create_unique(u'pinna_stationsubscriber', ['profile_id', 'station_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StationSubscriber', fields ['profile', 'station']
        db.delete_unique(u'pinna_stationsubscriber', ['profile_id', 'station_id'])
    ...
    models = {
        ...
        u'pinna.pinnasession': {
            ...
            'expired_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 21, 0, 0)'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
