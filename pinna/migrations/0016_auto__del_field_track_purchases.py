...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Track.purchases'
        db.delete_column(u'pinna_track', 'purchases')

        # Adding M2M table for field purchases on 'Track'
        m2m_table_name = db.shorten_name(u'pinna_track_purchases')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('track', models.ForeignKey(orm[u'pinna.track'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['track_id', 'user_id'])


    def backwards(self, orm):
        # Adding field 'Track.purchases'
        db.add_column(u'pinna_track', 'purchases',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Removing M2M table for field purchases on 'Track'
        db.delete_table(db.shorten_name(u'pinna_track_purchases'))
    ...
    models = {
        ...
        u'pinna.pinnasession': {
            ...
            'expired_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 14, 0, 0)'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
