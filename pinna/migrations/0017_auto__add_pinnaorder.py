...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PinnaOrder'
        db.create_table(u'pinna_pinnaorder', (
            ('order_id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('purchase_state', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('purchase_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('purchase_data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'pinna', ['PinnaOrder'])


    def backwards(self, orm):
        # Deleting model 'PinnaOrder'
        db.delete_table(u'pinna_pinnaorder')
    ...
    models = {
        ...
        u'pinna.pinnaorder': {
            ...
            'purchase_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
