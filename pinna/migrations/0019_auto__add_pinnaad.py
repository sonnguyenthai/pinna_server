...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PinnaAd'
        db.create_table(u'pinna_pinnaad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=2083, null=True)),
            ('s3_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pinna', ['PinnaAd'])


    def backwards(self, orm):
        # Deleting model 'PinnaAd'
        db.delete_table(u'pinna_pinnaad')
