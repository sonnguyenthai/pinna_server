...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PinnaSettings'
        db.create_table(u'pinna_pinnasettings', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True)),
            ('play_ad_after', self.gf('django.db.models.fields.IntegerField')(default=5)),
        ))
        db.send_create_signal(u'pinna', ['PinnaSettings'])


    def backwards(self, orm):
        # Deleting model 'PinnaSettings'
        db.delete_table(u'pinna_pinnasettings')
    ...
    models = {
        ...
        u'pinna.pinnasettings': {
            ...
            'play_ad_after': ('django.db.models.fields.IntegerField', [], {'default': '5'})
        },
        u'pinna.playlist': {
