...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PinnaSettings.play_ad_after'
        db.delete_column(u'pinna_pinnasettings', 'play_ad_after')

        # Adding field 'PinnaSettings.play_ad_after_songs'
        db.add_column(u'pinna_pinnasettings', 'play_ad_after_songs',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PinnaSettings.play_ad_after'
        db.add_column(u'pinna_pinnasettings', 'play_ad_after',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Deleting field 'PinnaSettings.play_ad_after_songs'
        db.delete_column(u'pinna_pinnasettings', 'play_ad_after_songs')
    ...
    models = {
        ...
        u'pinna.pinnaad': {
            'Meta': {'object_name': 'PinnaAd'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            's3_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '2083', 'null': 'True'})
        },
        u'pinna.pinnaorder': {
        ...
        u'pinna.pinnasession': {
            ...
            'expired_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 20, 0, 0)'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '40', 'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pinna.pinnasettings': {
            'Meta': {'object_name': 'PinnaSettings'},
            'id': ('django.db.models.fields.CharField', [], {'max_length': '40', 'primary_key': 'True'}),
            'play_ad_after_songs': ('django.db.models.fields.IntegerField', [], {'default': '5'})
        },
        u'pinna.playlist': {
        ...
        u'pinna.track': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'price': ('django.db.models.fields.FloatField', [], {'default': '15'}),
            'privacy_level': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
